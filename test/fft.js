...
describe('fft.js', function () {
  ...
  describe('fft_helpers', function () {
    ...
    it('detects wrong radix', function () {
      const fftCalcWrong = new Fft(1234)
